...
@Client.on_message(filters.command(['info', 'info@tgvcplayerbot']) & ~filters.edited & ~filters.bot)
@database_check
@chat_allowed
@admin_check
...
@Client.on_message(filters.command(['start', 'start@tgvcplayerbot', 'help', 'help@tgvcplayerbot']) & ~filters.edited)
